...
* [StructureDefinition-PreQualDBAPI.schema.json](schemas/StructureDefinition-PreQualDBAPI.schema.json) - JSON Schema for WHO Vaccine PreQual DB (API)
...
* [StructureDefinition-PreQualProduct.schema.json](schemas/StructureDefinition-PreQualProduct.schema.json) - JSON Schema for WHO PreQual Product
...
### Logical Model Schemas (12 available)
...
[🩺 FHIR](StructureDefinition-PreQualProduct.md)
[📄 JSON Schema](schemas/StructureDefinition-PreQualProduct.schema.json)
[🔗 OpenAPI](schemas/StructureDefinition-PreQualProduct.openapi.json)
...
Logical model for the vaccine type details from the WHO PreQual API (ProductDetails.VaccineDetails). Contains only vaccine-type-level fields that are stable across products. Product-specific fields (CommercialName, RouteOfAdministration) remain on PreQualProduct.
...
#### StructureDefinition-PreQualDBAPI Endpoints

API endpoints for WHO Vaccine PreQual DB (API)
...
#### StructureDefinition-PreQualProduct Endpoints

API endpoints for WHO PreQual Product
...
#### StructureDefinition-PreQualDBAPI.schema API

OpenAPI specification for StructureDefinition-PreQualDBAPI.schema

[🔗 OpenAPI Spec](schemas/StructureDefinition-PreQualDBAPI.schema.json)
...
#### StructureDefinition-PreQualDBAPI API

OpenAPI specification for StructureDefinition-PreQualDBAPI

[📖 Documentation](StructureDefinition-PreQualDBAPI.md)
[🔗 OpenAPI Spec](schemas/StructureDefinition-PreQualDBAPI.openapi.json)
...
#### StructureDefinition-PreQualProduct API

OpenAPI specification for StructureDefinition-PreQualProduct

[📖 Documentation](StructureDefinition-PreQualProduct.md)
[🔗 OpenAPI Spec](schemas/StructureDefinition-PreQualProduct.openapi.json)
