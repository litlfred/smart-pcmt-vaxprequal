...
* applicantId 0..1 Identifier "Salesforce applicant/manufacturer organization ID"
* applicantName 1..1 string "Applicant/manufacturer organization name"
* applicantAddress 0..1 Address "Applicant organization address"
* nraId 0..1 Identifier "Salesforce NRA organization ID"
* nraName 1..1 string "Responsible NRA name"
